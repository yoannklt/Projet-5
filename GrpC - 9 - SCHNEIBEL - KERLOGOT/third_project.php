...
<body>
  ...
  <div class="parallax-container">
    <div class="parallax"><img src="img/video-game.jpg" alt="Sam&Yoann Portfolio image d'un jeu video"></div>
  </div>
  <div class="row">
        ...
        <div class="col offset-l2 offset-m3 l6 m12 s12">
          <div class="card large green lighten-4">
            <div class="card-image">
              <img src="img/logo-tic80.png" alt="Sam&Yoann Portfolio logo de tic-80">
            </div>
            <div class="card-content">
              <p>Projet réalisé par Yoann.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="second-parallax" class="parallax-container">
    <div class="parallax"><img class="edit" src="img/video-game-3.jpg" alt="Sam&Yoann Portfolio image de jeu video"></div>
  </div>

  <div id="us" class="row">
    <div class="col s12 m12 l6 wow animate__animated animate__backInRight">
      <img class="image" src="img/space-invader.jpg" alt="Sam&Yoann Portfolio image du jeu video space-invader">
    </div>
    <div class="col s12 m12 l6 wow animate__animated animate__backInRight">
      <h2>Inspiré de Space Invader</h2>
      <p>En effet le but était de créer un jeu simple, je suis donc parti sur un type de jeu d'arcade avec peu d'élément et un gameplay attractif.</p>
    </div>
  </div>
  ...
  <ul class="pagination center wow animate__animated animate__backInUp">
    ...
    <li class="waves-effect"><a class="green-text text-lighten-2" href="second_project.html">2</a></li>
    <li class="active green lighten-2"><a class="green-text text-lighten-5" href="third_project.html">3</a></li>
  </ul>
